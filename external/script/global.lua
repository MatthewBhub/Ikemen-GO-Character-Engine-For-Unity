...
function statusInfo(p)
	...
	local ret = string.format("P%d: %d; LIF:%4d; POW:%4d; ATK:%4d; DEF:%4d; RED:%4d; GRD:%4d; STN:%4d", playerno(), id(), life(), power(), attack(), defence(), redlife(), guardpoints(), dizzypoints())
	playerid(oldid)
	return ret
end
