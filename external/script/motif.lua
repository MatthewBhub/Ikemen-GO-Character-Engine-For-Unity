...
local motif =
{
	...
	select_info =
	{
		...
		p1_palmenu_preview_snd = {-1, 0}, --Ikemen feature (data read from character SND)
		...
		p2_palmenu_preview_snd = {-1, 0}, --Ikemen feature (data read from character SND)
	...
	vs_screen =
	{
		...
		stage_font = {-1, 0, 0, 255, 255, 255, 255, -1}, --Ikemen feature
		stage_offset = {0, 0}, --Ikemen feature
		stage_xshear = 0.0, --Ikemen feature
		stage_angle = 0.0, --Ikemen feature
		stage_scale = {1.0, 1.0}, --Ikemen feature
		stage_portrait_anim = -1, --Ikemen feature
		stage_portrait_spr = {}, --Ikemen feature
		stage_portrait_offset = {0, 0}, --Ikemen feature
		stage_portrait_scale = {1.0, 1.0}, --Ikemen feature
